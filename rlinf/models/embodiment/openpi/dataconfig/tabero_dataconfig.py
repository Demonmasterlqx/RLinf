...
from rlinf.models.embodiment.openpi.policies import tabero_policy


@dataclasses.dataclass(frozen=True)
class TaberoTacImgDataConfig(DataConfigFactory):
    """Tabero three-image data config with 13D action/force outputs."""
...
class TaberoTacFieldDataConfig(DataConfigFactory):
    """Tabero two-image plus marker-motion tactile-prefix data config."""
