...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=OpenPi0Config(
            config_name="pi0_lora_tacfield_tabero_xarm_gripper",
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            action_dim=32,
            action_horizon=50,
    ...
    TrainConfig(
        ...
        data=TaberoTacFieldDataConfig(
            ...
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(asset_id="pi05_horizon50_tacfield_task820_firm"),
            extra_delta_transform=True,
        ),
        batch_size=32,
        lr_schedule=_optimizer.CosineDecaySchedule(
        ...
        pytorch_weight_path="/root/Tabero/models/pi05_base_pytorch",
    ...
    TrainConfig(
        ...
        model=OpenPi0Config(
            config_name="pi05_lora_tacfield_realworld_replayed_task820_firm_mixed_no_state",
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            action_dim=32,
    ...
    TrainConfig(
        ...
        model=OpenPi0Config(
            config_name="pi05_lora_tacfield_tabero_no_state",
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            action_dim=32,
        ...
        pytorch_weight_path="models/pi05_base_pytorch",
        num_train_steps=30_000,
        seed=42,
        ema_decay=0.99,
    ),
    TrainConfig(
        ...
        model=OpenPi0Config(
            config_name=("pi05_lora_tacfield_tabero_firmly_tightly_no_adverb_no_state"),
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            action_dim=32,
        ...
        data=TaberoTacFieldDataConfig(
            ...
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(
                asset_id=("pi05_horizon50_tacfield_tabero_firmly_tightly_no_adverb")
            ),
            extra_delta_transform=True,
        ),
        batch_size=64,
    ...
    TrainConfig(
        name="pi05_lora_tacforce_tcn_real",
        model=OpenPi0Config(
            config_name="pi05_lora_tacforce_tcn_real",
            pi05=True,
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            action_dim=32,
        ...
        data=TaberoTacForceDataConfig(
            ...
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(asset_id="pi05_horizon50_tacforce_tcn"),
            extra_delta_transform=True,
        ),
        batch_size=32,
        lr_schedule=_optimizer.CosineDecaySchedule(
        ...
        pytorch_weight_path="/data/home/sim6g/code/tabero/models/pi05_base_pytorch",
        num_train_steps=30_000,
        seed=42,
        ema_decay=0.99,
    ),
