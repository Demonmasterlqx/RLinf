...
readonly CONFIG_NAME="isaaclab_pi0_peft_lora_tacfield_tabero_task0_no_adverb_uniform_physics_no_damage_force_reward_2gpu_100step"
...
export TABERO_PIRL_SMOKE_OUTPUT_PREFIX="tabero_task0_no_adverb_uniform_physics_no_damage_force_reward_action_expert_lora_2gpu_capacity_smoke"
export TABERO_PIRL_FORMAL_OUTPUT_PREFIX="tabero_task0_no_adverb_uniform_physics_no_damage_force_reward_action_expert_lora_2gpu_100step"
